    ...
    value: function getLocation() {
      ...
      new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
        ...
        geolocation.getCurrentPosition(function (position) {
          ...
          var WEATHER_URL = 'http://api.openweathermap.org/data/2.5/forecast?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude + '&appid=' + API_KEY;
          ...
          __WEBPACK_IMPORTED_MODULE_12_axios___default.a.get(WEATHER_URL).then(function (res) {
            if (res.data.cod !== '200' && res.data.message) {
              ...
              _this2.props.weatherData = res.data;
              return res.data;
            }
          }, function (res) {
            throw new Error(res.data.message);
...
//# sourceMappingURL=index.3deade040fffbab09fab.js.map