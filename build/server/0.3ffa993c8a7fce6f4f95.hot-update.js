      ...
      return __WEBPACK_IMPORTED_MODULE_12_axios___default.a.get(WEATHER_URL).then(function (res) {
        if (res.data.cod !== '200' && res.data.message) {
          ...
          res.data.list.map(function (timeData, index) {
            ...
            */
            if (index === 0) {
              currentDay = __WEBPACK_IMPORTED_MODULE_10_moment___default()(res.data.list[index].dt_text).format('dddd');
            }
            ...
            if (currentDay === day) {
              ...
              fiveDayForecast.push(dayArray);
              dayArray = new Array();
              currentDay = __WEBPACK_IMPORTED_MODULE_10_moment___default()(timeData.dt_text).format('dddd');
              console.log(currentDay);
            }

            var currentDay = __WEBPACK_IMPORTED_MODULE_10_moment___default()(timeData.dt_txt).format('dddd');
          });
          _this3.setState({
...
//# sourceMappingURL=index.c6331b92eb68f73fc8e0.js.map