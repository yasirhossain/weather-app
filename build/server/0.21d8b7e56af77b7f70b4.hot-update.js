  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
    ...
    value: function render() {
      ...
      var mainCardStyle = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({
        background: '-webkit-linear-gradient(90deg, $hot ' + 100 / this.state.currentData.main.temp + '%, $cold)'
      }, 'background', 'linear-gradient(90deg, $hot ' + 100 / this.state.currentData.main.temp + '%, $cold)');
...
//# sourceMappingURL=index.6653a1bb21a9a873c043.js.map