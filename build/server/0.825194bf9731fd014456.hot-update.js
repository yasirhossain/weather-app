  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
    ...
    value: function render() {
      ...
      var mainCardStyle = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({
        background: '-webkit-linear-gradient(0deg, #43cff3, #fc6343 ' + this.state.currentData.main.temp + '%)'
      }, 'background', 'linear-gradient(0deg, #43cff3, #fc6343 ' + this.state.currentData.main.temp + '%)');
...
//# sourceMappingURL=index.564d9088976031ae4551.js.map