  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
    ...
    value: function render() {
      ...
      var mainCardStyle = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({
        background: '-webkit-linear-gradient(0deg, #e57263 ' + this.state.currentData.main.temp + '%, #2dcdf8)'
      }, 'background', 'linear-gradient(0deg, #e57263 ' + this.state.currentData.main.temp + '%, #2dcdf8)');
          ...
          __WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
            ...
            this.state.forecastData.map(function (day) {
              ...
              var dayCardStyle = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({
                background: '-webkit-linear-gradient(0deg, #e57263 ' + day.temp.day + '%, #2dcdf8)'
              }, 'background', 'linear-gradient(0deg, #e57263 ' + day.temp.day + '%, #2dcdf8)');
              return __WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
                'li',
...
//# sourceMappingURL=index.0ed855da2cd6471557fe.js.map