      ...
      return __WEBPACK_IMPORTED_MODULE_12_axios___default.a.get(WEATHER_URL).then(function (res) {
        if (res.data.cod !== '200' && res.data.message) {
          ...
          res.data.list.map(function (timeData, index) {
            //let currentDay = momentjs(timeData.dt_txt).format('dddd');
            ...
            */
            ...
            if (index === 0) {
              var _currentDay = __WEBPACK_IMPORTED_MODULE_10_moment___default()(timeData.dt_txt).format('dddd');
              return;
            }
...
//# sourceMappingURL=index.bc074762ab4fb5a3a0fe.js.map