...
var Weather = function (_React$Component) {
  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
    ...
    value: function getCityData(city) {
      ...
      var WEATHER_CITY_URL = 'http://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=' + this.API_KEY + '&units=' + this.metric;
      __WEBPACK_IMPORTED_MODULE_13_axios___default.a.get(WEATHER_CITY_URL).then(function (res) {
        if (res.data.cod !== '200' && res.data.message) {
          ...
          _this3.getWeatherForecast(res.data.coord.lat, res.data.coord.lon);
          return res.data;
        }
      }, function (res) {
        throw new Error(res.data.message);
    ...
    value: function getCurrentWeather(lat, long) {
      ...
      var WEATHER_CURRENT_URL = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&appid=' + this.API_KEY + '&units=' + this.metric;
    ...
    value: function getWeatherForecast(lat, long) {
      ...
      var WEATHER_FORECAST_URL = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat=' + lat + '&lon=' + long + '&appid=' + this.API_KEY + '&units=' + this.metric + '&cnt=5';
    ...
    key: 'toggleMetric',
    value: function toggleMetric(metric, event) {
      console.log(metric);
    }
  }, {
    ...
    value: function renderMetricToggle() {
      return __WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
          'li',
          { onClick: this.toggleMetric.bind('imperial', this) },
          'Farenheight'
        ),
        __WEBPACK_IMPORTED_MODULE_7_react___default.a.createElement(
          'li',
          { onClick: this.toggleMetric.bind('metric', this) },
          'Celcius'
        )
      );
    }
...
//# sourceMappingURL=index.74d65083b35c2fd88624.js.map