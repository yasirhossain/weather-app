...
var Weather = function (_React$Component) {
  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
    ...
    value: function getCityData(city) {
      ...
      var WEATHER_CITY_URL = 'http://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=' + this.API_KEY + '&units=imperial';
    ...
    value: function getCurrentWeather(lat, long) {
      ...
      var WEATHER_CURRENT_URL = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&appid=' + this.API_KEY + '&units=imperial';
    ...
    value: function getWeatherForecast(lat, long) {
      ...
      var WEATHER_FORECAST_URL = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat=' + lat + '&lon=' + long + '&appid=' + this.API_KEY + '&units=imperial&cnt=5';
...
//# sourceMappingURL=index.b7123b6b647e75363d71.js.map