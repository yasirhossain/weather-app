...
var Weather = function (_React$Component) {
  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
      ...
      if (navigator) {
        ...
        new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
          geolocation.getCurrentPosition(function (position) {
            ...
            _this2.getWeatherForecast(_this2.state.lat, _this2.state.lon);
          }, function () {
    ...
    value: function getCityData(city) {
      ...
      __WEBPACK_IMPORTED_MODULE_13_axios___default.a.get(WEATHER_CITY_URL).then(function (res) {
        if (res.data.cod !== '200' && res.data.message) {
          ...
          _this3.getWeatherForecast(_this3.state.lat, _this3.state.lon);
          return res.data;
        }
      }, function (res) {
        throw new Error(res.data.message);
    ...
    value: function getWeatherForecast(lat, long) {
      ...
      var WEATHER_FORECAST_URL = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat=' + lat + '&lon=' + long + '&appid=' + this.API_KEY + '&units=' + this.state.metric + '&cnt=5';
    ...
    value: function toggleMetric(metric) {
      ...
      this.getWeatherForecast(this.state.lat, this.state.lon);
    }
  }, {
...
//# sourceMappingURL=index.ca3967a4e8ccf3b90c0b.js.map