  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Weather, [{
    ...
    value: function render() {
      var mainCardStyle = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()({
        background: '-webkit-linear-gradient(#43cff3 ' + this.state.currentData.main.temp + '%, #e56363)'
      }, 'background', 'linear-gradient(#43cff3 ' + this.state.currentData.main.temp + '%, #e56363)');
...
//# sourceMappingURL=index.bc516b682079a1e9a18e.js.map